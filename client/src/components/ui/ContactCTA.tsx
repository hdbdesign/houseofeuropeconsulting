...
const ContactCTA = () => {
  ...
  const title = t('contact.cta.title');
  const subtitleHighlight = t('contact.cta.subtitleHighlight');
  const subtitle = t('contact.cta.subtitle');
  const button = t('contact.cta.button');
