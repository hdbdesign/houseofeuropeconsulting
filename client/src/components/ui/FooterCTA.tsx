        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold font-heading mb-6 text-white">
              {t('cta.final.title') || 'Pronto para transformar seu negócio digital?'}
            </h2>
            <p className="text-lg text-gray-300 mb-10 max-w-3xl mx-auto">
              {t('cta.final.subtitle') || 'Junte-se a nós para criar soluções digitais inovadoras e impulsionar seu crescimento com estratégias personalizadas para o mundo digital.'}
            </p>
            <motion.div
            ...
            >
              <Link href="/contact">
                <ButtonCTA className="bg-[#FF601A] text-white hover:bg-[#FF601A]/90">
                  {t('cta.final.button') || 'Iniciar Projeto'} <ArrowRight className="ml-2 h-5 w-5 inline-block align-middle" />
                </ButtonCTA>
              </Link>
            </motion.div>
          </motion.div>
